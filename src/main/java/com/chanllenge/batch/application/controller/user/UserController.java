...
public class UserController {
	...
	public UserController(JobLauncher jobLauncher, Job importUserJob, ObjectMapper objectMapper,
	...
	public ResponseEntity<List<Map.Entry<Date, Long>>> filterActiveUsersPerDay(
			@RequestParam(value = "min", defaultValue = "1000") Long min) {
		try {
			List<Map.Entry<Date, Long>> response = userService.getActiveUsersPerDay(min);
			return ResponseEntity.ok(response);
		} catch (Exception e) {
